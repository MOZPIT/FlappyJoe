...
/* 
 * The ScreenManager class manages initializing and displaying full screen graphic modes.
 */
...
public class ScreenManager {
	...
	/*
	 * Enters full screen mode and changes the display mode. If the specified display mode is null or not compatible with this device, or if the
	 * display mode cannot be changed on this system, the current display mode is used.
	 * <p>
...
//	}
	...
	/*
	 * Gets the graphics context fro the display. The ScreenManager uses double buffering, so applications must call update() to show any graphics drawn.
	 * <p>
